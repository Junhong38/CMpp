...
class GADataset:
    ...
    @classmethod
    def initialize(cls, datapath, data_category, sub_category, n_pts, overfitting):
    ...
    def build_dataloader(cls, batch_size, nworker, split, visualize=False):
        ...
        dataset = DatasetBreakingBad(cls.datapath, cls.data_category, cls.sub_category, cls.n_pts, split, cls.overfitting, visualize)
