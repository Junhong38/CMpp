...
rm -rf checkpoint/G8NDB2_F_BV0V0_MH_HN_SINK_6/ && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python main.py --logpath G8NDB2_F_BV0V0_MH_HN_SINK_6 --backbone vn_unet --double_bacbone vn_unet --n_avn 0 --mlp_mode half --scale small --epochs 1 --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --hard_negative --batch_size 2 --wandb --wandb_entity CMppProject --wandb_project CMpp
rm -rf checkpoint/G8NDB2_F_BV0V0_MH_HN_SIG_6/ && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python main.py --logpath G8NDB2_F_BV0V0_MH_HN_SIG_6 --backbone vn_unet --double_bacbone vn_unet --n_avn 0 --mlp_mode half --scale small --epochs 1 --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --hard_negative --batch_size 2 --matching_norm_mode sigmoid --wandb --wandb_entity CMppProject --wandb_project CMpp
rm -rf checkpoint/G8NDB2_F_BV0V0_MH_HN_SOF_6/ && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python main.py --logpath G8NDB2_F_BV0V0_MH_HN_SOF_6 --backbone vn_unet --double_bacbone vn_unet --n_avn 0 --mlp_mode half --scale small --epochs 1 --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --hard_negative --batch_size 2 --matching_norm_mode softmax --wandb --wandb_entity CMppProject --wandb_project CMpp
rm -rf checkpoint/G8NDB2_F_BV0V0_MH_HN_SIG_NOSLACK_6/ && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python main.py --logpath G8NDB2_F_BV0V0_MH_HN_SIG_NOSLACK_6 --backbone vn_unet --double_bacbone vn_unet --n_avn 0 --mlp_mode half --scale small --epochs 1 --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --hard_negative --batch_size 2 --matching_norm_mode sigmoid --no_slack_variable --wandb --wandb_entity CMppProject --wandb_project CMpp
rm -rf checkpoint/G8NDB2_F_BV0V0_MH_HN_SOF_NOSLACK_6/ && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python main.py --logpath G8NDB2_F_BV0V0_MH_HN_SOF_NOSLACK_6 --backbone vn_unet --double_bacbone vn_unet --n_avn 0 --mlp_mode half --scale small --epochs 1 --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --hard_negative --batch_size 2 --matching_norm_mode softmax --no_slack_variable --wandb --wandb_entity CMppProject --wandb_project CMpp
