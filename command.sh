...
# [RE] Origin + Softmax (temperature, 1.0) + Distance: cossim
...
# [ING] Origin + Softmax (temperature, 1.0) + Distance: cossim + positive(0.1, offset 0) / negative(1.40, offset 0)
...
# [ING] Origin + Softmax (temperature, 1.0) + Distance: cossim + positive(0.005, offset 0) / negative(1.0, offset 0)
