...
# additional layers w/o normal flipping
rm -rf checkpoint/BASE/ && python main.py --model CMpp_equiassem --logpath BASE --scale small --multiplicity 1 --epochs 0 --n_avn 0 --detach_mode --use_opt_gram --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --wandb --wandb_entity triplepoint --wandb_project CMpp_new_normal
rm -rf checkpoint/add_frame_layers/ && python main.py --model CMpp_equiassem --logpath add_frame_layers --scale small --multiplicity 1 --epochs 0 --n_avn 0 --detach_mode --use_opt_gram --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --additional_VNLLReLU_for_frame --n_afl 2 --wandb --wandb_entity triplepoint --wandb_project CMpp_new_normal
rm -rf checkpoint/add_2_shape_layers/ && python main.py --model CMpp_equiassem --logpath add_2_shape_layers --scale small --multiplicity 1 --epochs 0 --n_avn 2 --detach_mode --use_opt_gram --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --wandb --wandb_entity triplepoint --wandb_project CMpp_new_normal
rm -rf checkpoint/add_frame_and_2shape_layers/ && python main.py --model CMpp_equiassem --logpath add_frame_and_2shape_layers --scale small --multiplicity 1 --epochs 0 --n_avn 2 --detach_mode --use_opt_gram --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --additional_VNLLReLU_for_frame --n_afl 2 --wandb --wandb_entity triplepoint --wandb_project CMpp_new_normal

# additional layers w/ normal flipping
rm -rf checkpoint/NF_CL_BASE/ && python main.py --model CMpp_equiassem --logpath NF_BASE --scale small --multiplicity 1 --epochs 0 --n_avn 0 --detach_mode --use_opt_gram --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --flip_normal --use_consistency_loss --wandb --wandb_entity triplepoint --wandb_project CMpp_new_normal
rm -rf checkpoint/NF_CL_add_frame_layers/ && python main.py --model CMpp_equiassem --logpath NF_add_frame_layers --scale small --multiplicity 1 --epochs 0 --n_avn 0 --detach_mode --use_opt_gram --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --flip_normal --use_consistency_loss --additional_VNLLReLU_for_frame --n_afl 2 --wandb --wandb_entity triplepoint --wandb_project CMpp_new_normal
rm -rf checkpoint/NF_CL_add_2_shape_layers/ && python main.py --model CMpp_equiassem --logpath NF_add_2_shape_layers --scale small --multiplicity 1 --epochs 0 --n_avn 2 --detach_mode --use_opt_gram --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --flip_normal --use_consistency_loss --wandb --wandb_entity triplepoint --wandb_project CMpp_new_normal
rm -rf checkpoint/NF_CL_add_frame_and_2shape_layers/ && python main.py --model CMpp_equiassem --logpath NF_add_frame_and_2shape_layers --scale small --multiplicity 1 --epochs 0 --n_avn 2 --detach_mode --use_opt_gram --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --flip_normal --use_consistency_loss --additional_VNLLReLU_for_frame --n_afl 2 --wandb --wandb_entity triplepoint --wandb_project CMpp_new_normal
