...
rm -rf checkpoint/SECOND_NFREEZE00125_G8NDB2_NPCFNR4C1_W10/ && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python main.py --scale full --load_ori checkpoint_1stStage/FIRST_G8NDB6SN_NPCFNR4C1/models/last.ckpt --logpath SECOND_NFREEZE00125_G8NDB2_NPCFNR4C1_W10 --epochs 0 --scheduler_mode cos --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --batch_size 2 --flip_normal_mode rightv4 --consistency_loss_weight 1.0 --ori_backbone_lr_weight 0.0125 --start_hard_neg_epoch 10 --wandb --wandb_entity CMppProject --wandb_project CMpp
...
sleep 2h && rm -rf checkpoint/THIRD_SEGMLPDICE_NFREEZE00125_G8NDB2_NPCFNR4C1/ && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python main.py --scale full --load_except_seg_head checkpoint_backup/SECOND_NFREEZE00125_G8NDB2_NPCFNR4C1/models/last.ckpt --logpath THIRD_SEGMLPDICE_NFREEZE00125_G8NDB2_NPCFNR4C1 --epochs 0 --scheduler_mode cos --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --batch_size 6 --flip_normal_mode rightv4 --seg_head_mode mlp --seg_loss_mode dice --wandb --wandb_entity CMppProject --wandb_project CMpp
