...
class EquiAssem_occ_v4(pl.LightningModule):
    def __init__(self, lr, backbone='eqcnn', visualize=False):
        super(EquiAssem_occ_v4, self).__init__()
    ...
    def forward_pass(self, in_dict, mode, optimizer_idx):
        ...
        out_dict['src_inv_feats_before'] = src_inv_feats_before
        out_dict['trg_inv_feats_before'] = trg_inv_feats_before
        out_dict['src_inv_feats'] = src_inv_feats
        out_dict['trg_inv_feats'] = trg_inv_feats
        ...
        out_dict['gt_corr'] = in_dict['gt_correspondence'].squeeze(0)
