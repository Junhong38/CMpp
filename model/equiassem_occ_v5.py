...
class EquiAssem_occ_v5(pl.LightningModule):
    def __init__(self, lr, backbone='eqcnn', visualize=False):
        super(EquiAssem_occ_v5, self).__init__()
        ...
        self.global_pooling = SEBlock(channels=1023)
    ...
    def forward_pass(self, in_dict, mode, optimizer_idx):
        ...
        src_occ_feats = self.global_pooling(src_occ_feats)
        trg_occ_feats = self.global_pooling(trg_occ_feats)
