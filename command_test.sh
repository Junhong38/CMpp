...
rm -rf checkpoint/TOP128_score_RANSAC_2t20/ && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python test.py --load checkpoint_backup/THIRD_SEGMLPDICE_NFREEZE00125_G8NDB2_NPCFNR4C1/models/last.ckpt --logpath TOP128_score_RANSAC_2t20 --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --flip_normal_mode rightv4 --seg_head_mode mlp --move_smaller --min_part 2 --max_part 20 --multi_part_assembly naive --infer_topk 128 --use_RANSAC --RANSAC_type score_dependent --use_predicted_normal --use_seg_result
rm -rf checkpoint/TOP128_score_RANSAC_pen_2t20/ && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python test.py --load checkpoint_backup/THIRD_SEGMLPDICE_NFREEZE00125_G8NDB2_NPCFNR4C1/models/last.ckpt --logpath TOP128_score_RANSAC_pen_2t20 --gpus 0 1 2 3 4 5 6 7 --n_worker 6 --flip_normal_mode rightv4 --seg_head_mode mlp --move_smaller --min_part 2 --max_part 20 --multi_part_assembly naive --infer_topk 128 --use_RANSAC --RANSAC_type score_dependent --use_predicted_normal --use_seg_result --use_penetration
