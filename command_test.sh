...
rm -r inlier_vis && python test.py --logpath TEST_RANSAC_scoreThres --seg_head_mode mlp --use_seg_result --using_seg_mode threshold --RANSAC_type score_dependent --infer_match_option all --RANSAC_normal_threshold 90 --RANSAC_strong_normal_threshold 90 --use_RANSAC --move_smaller --flip_normal_mode rightv4 --n_worker 6 --load  checkpoint/THIRD_SEGMLPDICE_NFREEZE00125_G8NDB2_NPCFNR4C1/models/last.ckpt --gpus 0 1 2 3 4 5 6 7 --visualize_mode light --viz_metric_name rrmse_geo --viz_metric_threshold 170

rm -rf inlier_vis && python test.py --logpath final_TEST_RANSAC_penetration_top500_N0_P0 --normal_buffer 0 --penetration_buffer 0 --seg_head_mode mlp --use_seg_result --using_seg_mode threshold --RANSAC_type score_dependent --infer_topk 500 --RANSAC_normal_threshold 0 --RANSAC_strong_normal_threshold 0 --use_RANSAC --move_smaller --flip_normal_mode rightv4 --n_worker 6 --load  checkpoint/THIRD_SEGMLPDICE_NFREEZE00125_G8NDB2_NPCFNR4C1/models/last.ckpt --gpus 0 1 2 3 4 5 6 7 --visualize_mode light --viz_metric_name rrmse_geo --viz_metric_threshold 170