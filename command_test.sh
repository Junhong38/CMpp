...
CUDA_VISIBLE_DEVICES=0 python test_mpa_shonan_T.py --load CM_checkpoint/CMNet_v2_pa_everyday.ckpt --logpath TEST_PA_SHONAN_origin_origin --scale full --n_worker 6 --div_mode origin --sampling_mode origin &
CUDA_VISIBLE_DEVICES=1 python test_mpa_shonan_T.py --load CM_checkpoint/CMNet_v2_pa_everyday.ckpt --logpath TEST_PA_SHONAN_new_origin --scale full --n_worker 6 --div_mode new --sampling_mode origin & 
CUDA_VISIBLE_DEVICES=2 python test_mpa_shonan_T.py --load CM_checkpoint/CMNet_v2_pa_everyday.ckpt --logpath TEST_PA_SHONAN_origin_new --scale full --n_worker 6 --div_mode origin --sampling_mode new &
CUDA_VISIBLE_DEVICES=3 python test_mpa_shonan_T.py --load CM_checkpoint/CMNet_v2_pa_everyday.ckpt --logpath TEST_PA_SHONAN_new_new --scale full --n_worker 6 --div_mode new --sampling_mode new &




CUDA_VISIBLE_DEVICES=4 python test_mpa_shonan_T.py --load CM_checkpoint/CMNet_v2_mpa_everyday.ckpt --logpath TEST_MPA_SHONAN_origin_origin --scale full --n_worker 6 --div_mode origin --sampling_mode origin &
CUDA_VISIBLE_DEVICES=5 python test_mpa_shonan_T.py --load CM_checkpoint/CMNet_v2_mpa_everyday.ckpt --logpath TEST_MPA_SHONAN_new_origin --scale full --n_worker 6 --div_mode new --sampling_mode origin & 
CUDA_VISIBLE_DEVICES=6 python test_mpa_shonan_T.py --load CM_checkpoint/CMNet_v2_mpa_everyday.ckpt --logpath TEST_MPA_SHONAN_origin_new --scale full --n_worker 6 --div_mode origin --sampling_mode new &
CUDA_VISIBLE_DEVICES=7 python test_mpa_shonan_T.py --load CM_checkpoint/CMNet_v2_mpa_everyday.ckpt --logpath TEST_MPA_SHONAN_new_new --scale full --n_worker 6 --div_mode new --sampling_mode new &
